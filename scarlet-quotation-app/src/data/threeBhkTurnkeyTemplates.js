...
export const threeBhkTurnkeyTemplates = {
  STANDARD: {
    ...
    sections: [
      ...
      section('WHOLE HOUSE', [
        ...
        pricedItem({ text: 'Children Bedroom - Roman Curtains with standard hardware', paramLabel: 'feet', paramValue: 30, rate: 250, editableRate: true }),
  ...
  PREMIUM: {
    ...
    sections: [
      ...
      section('WHOLE HOUSE', [
        subTitle('Curtains '),
        pricedItem({ text: 'Drawing Room - Arabian Curtains with standard hardware ', paramLabel: 'feet', paramValue: 50, rate: 350, editableRate: true }),
        pricedItem({ text: 'Master Bedroom - Arabian Curtains with standard hardware ', paramLabel: 'feet', paramValue: 30, rate: 350, editableRate: true }),
        pricedItem({ text: 'Sami Master Bedroom - Arabian Curtains with standard hardware ', paramLabel: 'feet', paramValue: 30, rate: 350, editableRate: true }),
        pricedItem({ text: 'Children Bedroom - Arabian Curtains with standard hardware ', paramLabel: 'feet', paramValue: 30, rate: 350, editableRate: true }),
  ...
  LUXURIOUS: {
    ...
    sections: [
      ...
      section('WHOLE HOUSE', [
        subTitle('Curtains '),
        pricedItem({ text: 'Drawing Room - Arabian & Sheer Curtains with standard hardware ', paramLabel: 'feet', paramValue: 80, rate: 600, editableRate: true }),
        pricedItem({ text: 'Master Bedroom - Arabian & Sheer Curtains with standard hardware ', paramLabel: 'feet', paramValue: 54, rate: 600, editableRate: true }),
        pricedItem({ text: 'Sami Master Bedroom - Arabian & Sheer Curtains with standard hardware ', paramLabel: 'feet', paramValue: 50, rate: 600, editableRate: true }),
        pricedItem({ text: 'Children Bedroom - Arabian & Sheer Curtains with standard hardware ', paramLabel: 'feet', paramValue: 50, rate: 600, editableRate: true }),
