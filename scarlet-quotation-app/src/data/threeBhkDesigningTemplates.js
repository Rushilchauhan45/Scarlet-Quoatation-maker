...
export const threeBhkDesigningTemplates = {
  STANDARD: {
    ...
    sections: [
      {
        ...
        items: [
          ...
          designingItem('Render 3d images after finalizing 3D modelling [3 BHK - 12 views]'),
          ...
          designingItem('Site Visit [10 Visit]'),
        ],
      },
    ],
  },
